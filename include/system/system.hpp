...
class System {
   public:
    ...
    bool fixed_time_step, normalize_before_masking, randomly_initialize_system, use_te_tm_splitting, periodic_boundary_conditions;
    ...
    */
    ...
    struct Parameters {
        ...
        Parameters( unsigned int N, real_number t, real_number dt, real_number xmax, real_number dx, 
            real_number m_e, real_number h_bar_s, real_number m_eff, real_number gamma_c, real_number gamma_r, real_number g_c, real_number g_r, real_number R, real_number g_pm, real_number delta_LT, bool periodic ) : 
        N(N), N2(N*N), 
        t(t), dt(dt), dt_half(dt/real_number(2.0)), 
        xmax(xmax), dx(dx), 
        m_e(m_e), m_eff(m_eff), 
        gamma_c(gamma_c), gamma_r(gamma_r), g_c(g_c), g_r(g_r), R(R), g_pm(g_pm), delta_LT(delta_LT), 
