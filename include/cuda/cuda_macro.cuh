    ...
    #define CALCULATE_K( index, input_wavefunction, input_reservoir ) {};
            ...
            #define CALCULATE_K( index, input_wavefunction, input_reservoir )                                                                                                      \
                {                                                                                                                                                                  \
                    ...
                    CALL_SUBGRID_KERNEL_MI( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, false, false, false, false )>, "K" #index, current_grid,             \
                                            current_block, stream, current_halo, kernel_arguments, io );                                                                           \
                    CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, false, false, false, false )>, "K" #index, current_grid, current_block, \
                                         stream, current_halo, kernel_arguments, io );                                                                                             \
                }
        #else
            #define CALCULATE_K( index, input_wavefunction, input_reservoir )                                                                                                      \
                {                                                                                                                                                                  \
                    ...
                    if ( system.use_reservoir ) {                                                                                                                                  \
                        if ( system.use_pulses ) {                                                                                                                                 \
                            if ( system.use_pumps ) {                                                                                                                              \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, true, true, true, true )>, "K" #index, current_grid, \
                                                             current_block, stream, current_halo, kernel_arguments, io );                                                          \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, true, true, true, false )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, true, true, false, true )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, true, true, false, false )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            } else {                                                                                                                                               \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, true, false, true, true )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, true, false, true, false )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, true, false, false, true )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, true, false, false, false )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            }                                                                                                                                                      \
                            ...
                            if ( system.use_pumps ) {                                                                                                                              \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, false, true, true, true )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, false, true, true, false )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, false, true, false, true )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, false, true, false, false )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            } else {                                                                                                                                               \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, false, false, true, true )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, false, false, true, false )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, false, false, false, true )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, true, false, false, false, false )>, "K" #index,           \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            }                                                                                                                                                      \
                        ...
                        if ( system.use_pulses ) {                                                                                                                                 \
                            if ( system.use_pumps ) {                                                                                                                              \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, true, true, true, true )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, true, true, true, false )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, true, true, false, true )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, true, true, false, false )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            } else {                                                                                                                                               \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, true, false, true, true )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, true, false, true, false )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, true, false, false, true )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, true, false, false, false )>, "K" #index,           \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            }                                                                                                                                                      \
                            ...
                            if ( system.use_pumps ) {                                                                                                                              \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, false, true, true, true )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, false, true, true, false )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, false, true, false, true )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, false, true, false, false )>, "K" #index,           \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            } else {                                                                                                                                               \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, false, false, true, true )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, false, false, true, false )>, "K" #index,           \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, false, false, false, true )>, "K" #index,           \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( false, false, false, false, false, false )>, "K" #index,          \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            }                                                                                                                                                      \
                    ...
                    if ( system.use_reservoir ) {                                                                                                                                  \
                        if ( system.use_pulses ) {                                                                                                                                 \
                            if ( system.use_pumps ) {                                                                                                                              \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, true, true, true, true )>, "K" #index, current_grid,  \
                                                             current_block, stream, current_halo, kernel_arguments, io );                                                          \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, true, true, true, false )>, "K" #index, current_grid, \
                                                             current_block, stream, current_halo, kernel_arguments, io );                                                          \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, true, true, false, true )>, "K" #index, current_grid, \
                                                             current_block, stream, current_halo, kernel_arguments, io );                                                          \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, true, true, false, false )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            } else {                                                                                                                                               \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, true, false, true, true )>, "K" #index, current_grid, \
                                                             current_block, stream, current_halo, kernel_arguments, io );                                                          \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, true, false, true, false )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, true, false, false, true )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, true, false, false, false )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            }                                                                                                                                                      \
                            ...
                            if ( system.use_pumps ) {                                                                                                                              \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, false, true, true, true )>, "K" #index, current_grid, \
                                                             current_block, stream, current_halo, kernel_arguments, io );                                                          \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, false, true, true, false )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, false, true, false, true )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, false, true, false, false )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            } else {                                                                                                                                               \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, false, false, true, true )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, false, false, true, false )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, false, false, false, true )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, true, false, false, false, false )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            }                                                                                                                                                      \
                        ...
                        if ( system.use_pulses ) {                                                                                                                                 \
                            if ( system.use_pumps ) {                                                                                                                              \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, true, true, true, true )>, "K" #index, current_grid, \
                                                             current_block, stream, current_halo, kernel_arguments, io );                                                          \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, true, true, true, false )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, true, true, false, true )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, true, true, false, false )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            } else {                                                                                                                                               \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, true, false, true, true )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, true, false, true, false )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, true, false, false, true )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, true, false, false, false )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            }                                                                                                                                                      \
                            ...
                            if ( system.use_pumps ) {                                                                                                                              \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, false, true, true, true )>, "K" #index,              \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, false, true, true, false )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, false, true, false, true )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, false, true, false, false )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            } else {                                                                                                                                               \
                                if ( system.use_potentials ) {                                                                                                                     \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, false, false, true, true )>, "K" #index,             \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, false, false, true, false )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                } else {                                                                                                                                           \
                                    if ( system.use_stochastic ) {                                                                                                                 \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, false, false, false, true )>, "K" #index,            \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    } else {                                                                                                                                       \
                                        CALL_SUBGRID_KERNEL( PHOENIX::Kernel::Compute::gp_scalar<GCC_EXPAND_VA_ARGS( true, false, false, false, false, false )>, "K" #index,           \
                                                             current_grid, current_block, stream, current_halo, kernel_arguments, io );                                            \
                                    }                                                                                                                                              \
                                }                                                                                                                                                  \
                            }                                                                                                                                                      \
        ...
        #define INTERMEDIATE_SUM_K( index, ... )                                                                                                                                  \
            {                                                                                                                                                                     \
                ...
                if ( system.use_reservoir ) {                                                                                                                                     \
                    if ( system.use_stochastic ) {                                                                                                                                \
                        if ( system.imag_time_amplitude == 0.0 ) {                                                                                                                \
                            CALL_SUBGRID_KERNEL( Kernel::Summation::runge_sum_to_input_k<GCC_EXPAND_VA_ARGS_ORDER( Type::complex, false, true, true, index, __VA_ARGS__ )>,       \
                                                 "Sum for K" #index, current_grid, current_block, stream, current_halo, kernel_arguments, io.in_wf_plus, io.out_wf_plus,          \
                                                 k_vec_wf_plus );                                                                                                                 \
                        } else {                                                                                                                                                  \
                    ...
                    if ( system.imag_time_amplitude == 0.0 ) {                                                                                                                    \
                        CALL_SUBGRID_KERNEL( Kernel::Summation::runge_sum_to_input_k<GCC_EXPAND_VA_ARGS_ORDER( Type::complex, false, false, true, index, __VA_ARGS__ )>,          \
                                             "Sum for K" #index, current_grid, current_block, stream, current_halo, kernel_arguments, io.in_rv_plus, io.out_rv_plus,              \
                                             k_vec_res_plus );                                                                                                                    \
                    } else {                                                                                                                                                      \
                        CALL_SUBGRID_KERNEL( Kernel::Summation::runge_sum_to_input_k<GCC_EXPAND_VA_ARGS_ORDER( Type::complex, true, false, true, index, __VA_ARGS__ )>,           \
                                             "Sum for K" #index, current_grid, current_block, stream, current_halo, kernel_arguments, io.in_rv_plus, io.out_rv_plus,              \
        ...
        {                                                                                                                                                 \
            ...
            if ( not cuda_graph_created or not with_graph ) {                                                                                             \
                ...
                if ( with_graph ) {                                                                                                                       \
                    ...
                    std::cout << PHOENIX::CLIO::prettyPrint( "CUDA Graph created with " + std::to_string( num_nodes ) + " nodes",                             \
                                                         PHOENIX::CLIO::Control::Secondary | PHOENIX::CLIO::Control::Info )                                       \
                              << std::endl;                                                                                                               \
                }                                                                                                                                         \
            } else {                                                                                                                                      \
