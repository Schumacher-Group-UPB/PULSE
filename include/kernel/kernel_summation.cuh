...
PULSE_GLOBAL PULSE_COMPILER_SPECIFIC void runge_sum_to_input_kw( Type::uint32 i, Type::uint32 current_halo, Solver::VKernelArguments time, Solver::KernelArguments args, Solver::InputOutput io ) {
