...
struct Device {
    ...
    void constructAll( const int N, bool use_te_tm_splitting, bool use_rk_45 ) {
        ...
        fft_plus.construct( N, "device.fft_plus" );

        // RK4(5) Matrices
        k1_wavefunction_plus.construct( N, "device.k1_wavefunction_plus" );
        k1_reservoir_plus.construct( N, "device.k1_reservoir_plus" );
        k2_wavefunction_plus.construct( N, "device.k2_wavefunction_plus" );
        k2_reservoir_plus.construct( N, "device.k2_reservoir_plus" );
        k3_wavefunction_plus.construct( N, "device.k3_wavefunction_plus" );
        k3_reservoir_plus.construct( N, "device.k3_reservoir_plus" );
        k4_wavefunction_plus.construct( N, "device.k4_wavefunction_plus" );
        k4_reservoir_plus.construct( N, "device.k4_reservoir_plus" );

        rk_error.construct( N, "device.rk_error" );

        if ( use_rk_45 ) {
            k5_wavefunction_plus.construct( N, "device.k5_wavefunction_plus" );
            k5_reservoir_plus.construct( N, "device.k5_reservoir_plus" );
            k6_wavefunction_plus.construct( N, "device.k6_wavefunction_plus" );
            k6_reservoir_plus.construct( N, "device.k6_reservoir_plus" );
            k7_wavefunction_plus.construct( N, "device.k7_wavefunction_plus" );
        ...
        k2_wavefunction_minus.construct( N, "device.k2_wavefunction_minus" );
        k2_reservoir_minus.construct( N, "device.k2_reservoir_minus" );
        k3_wavefunction_minus.construct( N, "device.k3_wavefunction_minus" );
        k3_reservoir_minus.construct( N, "device.k3_reservoir_minus" );
        k4_wavefunction_minus.construct( N, "device.k4_wavefunction_minus" );
        k4_reservoir_minus.construct( N, "device.k4_reservoir_minus" );
        if ( use_rk_45 ) {
            k5_wavefunction_minus.construct( N, "device.k5_wavefunction_minus" );
            k5_reservoir_minus.construct( N, "device.k5_reservoir_minus" );
            k6_wavefunction_minus.construct( N, "device.k6_wavefunction_minus" );
            k6_reservoir_minus.construct( N, "device.k6_reservoir_minus" );
            k7_wavefunction_minus.construct( N, "device.k7_wavefunction_minus" );
            k7_reservoir_minus.construct( N, "device.k7_reservoir_minus" );
        }
    }
