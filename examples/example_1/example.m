...
rng('shuffle');
delete('C:\Users\Jan Wingenbach\OneDrive - Universität Paderborn\Documents\GPU tests\example 1\PC3\load\*.txt');
%------------------------------------------Misc------------------------------------------%
gpudevice = 0;        %select your best GPU device (hint: 'gpuDeviceTable')

%--------------------------------time evolution settings---------------------------------%
tmax = 4200;              %time-evolution range
dt = 0.006;               %time-step
...
gammaC = 0.005;         %polariton loss rate in ps^-1
gc = 2E-3;              %polariton-polariton interaction strength in eVum^2
%--- write potential and initial condition into the load folder of PULSE ---%
