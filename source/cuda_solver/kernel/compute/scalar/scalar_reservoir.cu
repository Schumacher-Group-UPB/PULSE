...
CUDA_GLOBAL void PC3::Kernel::Compute::scalar_reservoir( int i, real_number t, Device::Pointers dev_ptrs, System::Parameters p, Solver::Oscillation::Pointers oscillation, InputOutput io ) {
