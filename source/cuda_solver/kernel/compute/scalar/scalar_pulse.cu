...
CUDA_GLOBAL void PC3::Kernel::Compute::scalar_pulse( int i, real_number t, MatrixContainer::Pointers dev_ptrs, System::Parameters p, Solver::Oscillation::Pointers oscillation, InputOutput io ) {
