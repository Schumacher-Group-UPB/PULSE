...
CUDA_GLOBAL void PC3::Kernel::RK45::runge_sum_to_input_of_k3( int i, complex_number dt, Device::Pointers dev_ptrs, System::Parameters p, bool use_twin_mode ) {
    OVERWRITE_THREAD_INDEX(i);
...
CUDA_GLOBAL void PC3::Kernel::RK45::runge_sum_to_input_of_k4( int i, complex_number dt, Device::Pointers dev_ptrs, System::Parameters p, bool use_twin_mode ) {
    OVERWRITE_THREAD_INDEX(i);
...
CUDA_GLOBAL void PC3::Kernel::RK45::runge_sum_to_input_of_k5( int i, complex_number dt, Device::Pointers dev_ptrs, System::Parameters p, bool use_twin_mode ) {
    OVERWRITE_THREAD_INDEX(i);
...
CUDA_GLOBAL void PC3::Kernel::RK45::runge_sum_to_input_of_k6( int i, complex_number dt, Device::Pointers dev_ptrs, System::Parameters p, bool use_twin_mode ) {
    OVERWRITE_THREAD_INDEX(i);
...
CUDA_GLOBAL void PC3::Kernel::RK45::runge_sum_to_final( int i, complex_number dt, Device::Pointers dev_ptrs, System::Parameters p, bool use_twin_mode ) {
    OVERWRITE_THREAD_INDEX(i);
...
CUDA_GLOBAL void PC3::Kernel::RK45::runge_sum_final_error( int i, complex_number dt, Device::Pointers dev_ptrs, System::Parameters p, bool use_twin_mode ) {
    OVERWRITE_THREAD_INDEX(i);
...
CUDA_GLOBAL void PC3::Kernel::RK4::runge_sum_to_input_k2( int i, complex_number dt, Device::Pointers dev_ptrs, System::Parameters p, bool use_twin_mode ) {
    OVERWRITE_THREAD_INDEX(i);

    dev_ptrs.buffer_wavefunction_plus[i] = dev_ptrs.wavefunction_plus[i] + 0.5*dt * dev_ptrs.k1_wavefunction_plus[i];
    dev_ptrs.buffer_reservoir_plus[i] = dev_ptrs.reservoir_plus[i] + 0.5*dt * dev_ptrs.k1_reservoir_plus[i];
    if ( not use_twin_mode ) 
        return;
    dev_ptrs.buffer_wavefunction_minus[i] = dev_ptrs.wavefunction_minus[i] + 0.5*dt * dev_ptrs.k1_wavefunction_minus[i];
    dev_ptrs.buffer_reservoir_minus[i] = dev_ptrs.reservoir_minus[i] + 0.5*dt * dev_ptrs.k1_reservoir_minus[i];
}

CUDA_GLOBAL void PC3::Kernel::RK4::runge_sum_to_input_k3( int i, complex_number dt, Device::Pointers dev_ptrs, System::Parameters p, bool use_twin_mode ) {
    OVERWRITE_THREAD_INDEX(i);

    dev_ptrs.buffer_wavefunction_plus[i] = dev_ptrs.wavefunction_plus[i] + 0.5*dt * dev_ptrs.k2_wavefunction_plus[i];
    dev_ptrs.buffer_reservoir_plus[i] = dev_ptrs.reservoir_plus[i] + 0.5*dt * dev_ptrs.k2_reservoir_plus[i];
    if ( not use_twin_mode ) 
        return;
    dev_ptrs.buffer_wavefunction_minus[i] = dev_ptrs.wavefunction_minus[i] + 0.5*dt * dev_ptrs.k2_wavefunction_minus[i];
    dev_ptrs.buffer_reservoir_minus[i] = dev_ptrs.reservoir_minus[i] + 0.5*dt * dev_ptrs.k2_reservoir_minus[i];
}

CUDA_GLOBAL void PC3::Kernel::RK4::runge_sum_to_input_k4( int i, complex_number dt, Device::Pointers dev_ptrs, System::Parameters p, bool use_twin_mode ) {
    OVERWRITE_THREAD_INDEX(i);
...
CUDA_GLOBAL void PC3::Kernel::RK4::runge_sum_to_final( int i, complex_number dt, Device::Pointers dev_ptrs, System::Parameters p, bool use_twin_mode ) {
    OVERWRITE_THREAD_INDEX(i);

    dev_ptrs.buffer_wavefunction_plus[i] = dev_ptrs.wavefunction_plus[i] + dt / 6.0 * ( dev_ptrs.k1_wavefunction_plus[i] + 2.0 * dev_ptrs.k2_wavefunction_plus[i] + 2.0 * dev_ptrs.k3_wavefunction_plus[i] + dev_ptrs.k4_wavefunction_plus[i] );
    dev_ptrs.buffer_reservoir_plus[i] = dev_ptrs.reservoir_plus[i] + dt / 6.0 * ( dev_ptrs.k1_reservoir_plus[i] + 2.0 * dev_ptrs.k2_reservoir_plus[i] + 2.0 * dev_ptrs.k3_reservoir_plus[i] + dev_ptrs.k4_reservoir_plus[i] );
    if ( not use_twin_mode ) 
        return;
    dev_ptrs.buffer_wavefunction_minus[i] = dev_ptrs.wavefunction_minus[i] + dt / 6.0 * ( dev_ptrs.k1_wavefunction_minus[i] + 2.0 * dev_ptrs.k2_wavefunction_minus[i] + 2.0 * dev_ptrs.k3_wavefunction_minus[i] + dev_ptrs.k4_wavefunction_minus[i] );
    dev_ptrs.buffer_reservoir_minus[i] = dev_ptrs.reservoir_minus[i] + dt / 6.0 * ( dev_ptrs.k1_reservoir_minus[i] + 2.0 * dev_ptrs.k2_reservoir_minus[i] + 2.0 * dev_ptrs.k3_reservoir_minus[i] + dev_ptrs.k4_reservoir_minus[i] );
}