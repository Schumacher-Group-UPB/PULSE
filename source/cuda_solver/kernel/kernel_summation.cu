...
PULSE_GLOBAL void PC3::Kernel::RK45::runge_sum_to_input_of_k2( int i, Type::complex dt, MatrixContainer::Pointers dev_ptrs, SystemParameters::KernelParameters p ) {
...
PULSE_GLOBAL void PC3::Kernel::RK45::runge_sum_to_input_of_k3( int i, Type::complex dt, MatrixContainer::Pointers dev_ptrs, SystemParameters::KernelParameters p ) {
    OVERWRITE_THREAD_INDEX(i);
...
PULSE_GLOBAL void PC3::Kernel::RK45::runge_sum_to_input_of_k4( int i, Type::complex dt, MatrixContainer::Pointers dev_ptrs, SystemParameters::KernelParameters p ) {
    OVERWRITE_THREAD_INDEX(i);
...
PULSE_GLOBAL void PC3::Kernel::RK45::runge_sum_to_input_of_k5( int i, Type::complex dt, MatrixContainer::Pointers dev_ptrs, SystemParameters::KernelParameters p ) {
    OVERWRITE_THREAD_INDEX(i);
...
PULSE_GLOBAL void PC3::Kernel::RK45::runge_sum_to_input_of_k6( int i, Type::complex dt, MatrixContainer::Pointers dev_ptrs, SystemParameters::KernelParameters p ) {
    OVERWRITE_THREAD_INDEX(i);
...
PULSE_GLOBAL void PC3::Kernel::RK45::runge_sum_to_final( int i, Type::complex dt, MatrixContainer::Pointers dev_ptrs, SystemParameters::KernelParameters p ) {
    OVERWRITE_THREAD_INDEX(i);
...
PULSE_GLOBAL void PC3::Kernel::RK45::runge_sum_final_error( int i, Type::complex dt, MatrixContainer::Pointers dev_ptrs, SystemParameters::KernelParameters p ) {
    OVERWRITE_THREAD_INDEX(i);
...
PULSE_GLOBAL void PC3::Kernel::RK4::runge_sum_to_input_k2( int i, Type::complex dt, MatrixContainer::Pointers dev_ptrs, SystemParameters::KernelParameters p ) {
    OVERWRITE_THREAD_INDEX(i);
...
PULSE_GLOBAL void PC3::Kernel::RK4::runge_sum_to_input_k3( int i, Type::complex dt, MatrixContainer::Pointers dev_ptrs, SystemParameters::KernelParameters p ) {
    OVERWRITE_THREAD_INDEX(i);
...
PULSE_GLOBAL void PC3::Kernel::RK4::runge_sum_to_input_k4( int i, Type::complex dt, MatrixContainer::Pointers dev_ptrs, SystemParameters::KernelParameters p ) {
    OVERWRITE_THREAD_INDEX(i);
...
PULSE_GLOBAL void PC3::Kernel::RK4::runge_sum_to_final( int i, Type::complex dt, MatrixContainer::Pointers dev_ptrs, SystemParameters::KernelParameters p ) {
    OVERWRITE_THREAD_INDEX(i);
