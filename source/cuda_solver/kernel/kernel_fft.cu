...
PULSE_GLOBAL void PC3::Kernel::kernel_make_fft_visible( int i, Type::complex* input, Type::complex* output, const Type::uint N ) {
...
PULSE_GLOBAL void PC3::Kernel::fft_shift_2D( int i, Type::complex* data, const Type::uint N_x, const Type::uint N_y ) {
...
PULSE_GLOBAL void PC3::Kernel::kernel_mask_fft( int i, Type::complex* data, Type::real* mask, const Type::uint N ) {
    GET_THREAD_INDEX( i, N );
