...
CUDA_GLOBAL void PC3::Kernel::runge_func_kernel_tetm( int i, real_number t, Device::Pointers dev_ptrs, System::Parameters p,
    ...
    PC3::Hamilton::tetm_plus( hamilton_regular_plus, hamilton_minus_cross, io.in_wf_plus, i, row, col, p.N );
    PC3::Hamilton::tetm_minus( hamilton_regular_minus, hamilton_cross_plus, io.in_wf_minus, i, row, col, p.N );
...
CUDA_GLOBAL void PC3::Kernel::runge_func_kernel_scalar( int i, real_number t, Device::Pointers dev_ptrs, System::Parameters p,
    ...
    PC3::Hamilton::scalar( hamilton_regular_plus, io.in_wf_plus, i, row, col, p.N );
