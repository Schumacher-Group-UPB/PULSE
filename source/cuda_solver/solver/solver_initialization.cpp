...
void PC3::Solver::outputInitialMatrices() {
    ...
    if ( system.doOutput( "mat", "potential_plus", "potential" ) )
        system.filehandler.outputMatrixToFile( host.potential_plus.get(), system.s_N, system.xmax, system.dx, "potential_plus" );
    ...
    if ( system.doOutput( "mat", "potential_minus", "potential" ) )
        system.filehandler.outputMatrixToFile( host.potential_minus.get(), system.s_N, system.xmax, system.dx, "potential_minus" );
...
void PC3::Solver::initializeHostMatricesFromSystem( ) {
    ...
    host.constructAll( system.s_N, system.use_te_tm_splitting, not system.fixed_time_step  /* Use RK45 */ );
...
void PC3::Solver::initializeDeviceMatricesFromHost() {
    ...
    device.constructAll( system.s_N, system.use_te_tm_splitting, not system.fixed_time_step /* Use RK45 */ );
