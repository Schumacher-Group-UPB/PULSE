 ...
 */
__global__ void rungeFuncFinalError( double* out, cuDoubleComplex* in_Psi_Plus, cuDoubleComplex* in_Psi_Minus, cuDoubleComplex* in_n_Plus, cuDoubleComplex* in_n_Minus, cuDoubleComplex* __restrict__ k1_Psi_Plus, cuDoubleComplex* __restrict__ k1_Psi_Minus, cuDoubleComplex* __restrict__ k1_n_Plus, cuDoubleComplex* __restrict__ k1_n_Minus, cuDoubleComplex* __restrict__ k3_Psi_Plus, cuDoubleComplex* __restrict__ k3_Psi_Minus, cuDoubleComplex* __restrict__ k3_n_Plus, cuDoubleComplex* __restrict__ k3_n_Minus, cuDoubleComplex* __restrict__ k4_Psi_Plus, cuDoubleComplex* __restrict__ k4_Psi_Minus, cuDoubleComplex* __restrict__ k4_n_Plus, cuDoubleComplex* __restrict__ k4_n_Minus, cuDoubleComplex* __restrict__ k5_Psi_Plus, cuDoubleComplex* __restrict__ k5_Psi_Minus, cuDoubleComplex* __restrict__ k5_n_Plus, cuDoubleComplex* __restrict__ k5_n_Minus, cuDoubleComplex* __restrict__ k6_Psi_Plus, cuDoubleComplex* __restrict__ k6_Psi_Minus, cuDoubleComplex* __restrict__ k6_n_Plus, cuDoubleComplex* __restrict__ k6_n_Minus, cuDoubleComplex* __restrict__ k7_Psi_Plus, cuDoubleComplex* __restrict__ k7_Psi_Minus, cuDoubleComplex* __restrict__ k7_n_Plus, cuDoubleComplex* __restrict__ k7_n_Minus ) {
    int blockId = ( gridDim.x * blockIdx.y ) + blockIdx.x;
    int i = ( blockId * ( blockDim.x * blockDim.y ) ) + ( threadIdx.y * blockDim.x ) + threadIdx.x;
    if ( i < dev_s_N * dev_s_N ) {
        out[i] = 0.0;
