...
if [[ "$1" == "7763_ccd" ]];
then
  likwid-bench -t triad_avx_fma -W S0:16000kB:8
  likwid-bench -t triad_mem_avx_fma -W S0:6400000kB:8
  likwid-bench -t peakflops_avx_fma -W S0:16000kB:8
  likwid-bench -t peakflops_sp_avx_fma -W S0:16000kB:8
fi
